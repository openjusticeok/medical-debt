...
sc %>% 
  ...
  arrange(desc(n)) 
```
We see that over 343,039 cases are evictions. We can discard those. 
...
To classify the remaining 248,557 cases, we comb through the plaintiffs and classify them. We can repeat the three steps above until we have enough of them classified.
...
```
That gives us 26,533 lawsuits filed. 
