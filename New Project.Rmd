...
This project aims to shed new light on the extnt of the medical debt problem in Oklahoma using court data. 
...
The analysis will be able to identify trends in these cases over the past 20 years (2000-2019)

## Geography

What courts/counties/states are you looking at?
This project will be focused on medical debt collection cases in civil courts across Oklahoma.
