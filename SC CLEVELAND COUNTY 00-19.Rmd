...
sc %>% 
  ...
  arrange(desc(n)) 
```
We see that over 91,342 cases are evictions. We can discard those. 
...
To classify the remaining 86,779 cases, we comb through the plaintiffs and classify them. We can repeat the three steps above until we have enough of them classified.
...
```
That gives us 9,770 lawsuits filed. 
