---
title: "SC CLEVELAND County 00-19"
author:
  - Leticia, Fellow
...
``` {r}
debt <- debt %>% 
  mutate(plaint_cat = case_when(str_detect(iss_plaint, "NORMAN REGIONAL") ~ "NORMAN REGIONAL HEALTH SYSTEM",
