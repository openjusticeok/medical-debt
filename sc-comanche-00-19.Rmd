...
sc %>% 
  ...
  arrange(desc(n)) 
```
We see that over 38,236 cases are evictions. We can discard those. 
...
```
To classify the remaining 43,167 cases, we comb through the plaintiffs and classify them. We can repeat the three steps above until we have enough of them classified.
