---
title: "SC Canadian County 00-19"
author:
  - Leticia, Fellow
...
``` {r}
debt <- debt %>% 
  mutate(plaint_type = case_when(str_detect(iss_plaint, "HEALTH|CLINIC|MEDICAL|HOSPITAL|INTEGRIS| DPM| DDS|MEDICINE|DENTAL|OPTOMETRISTS|COMPLETE\\sREHAB\\sINC|ORTHOPAEDIC|FOOT\\sAND\\sANKLE|CHIROPRACTIC|D\\.P\\.M\\.|PHYSICIANS|RADIOLOGY|SURGICAL|YUKON\\sWOUND\\sCARE\\s&\\sREHAB") ~ "MEDICAL",
