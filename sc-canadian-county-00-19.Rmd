...
This analysis focuses on small claims court cases in Cana County.
...
# other_counties <- ojo_query_disps(c("ROGERS", "ROGERMILLS", "PUSHMATAHA"), "SC", 2000:2019)
```
...
```
That gives us 6,628 lawsuits filed. 
